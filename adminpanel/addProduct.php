...
<div class="row">
  ...
  <script>
    document.getElementById('adminPanelCategoriesLink6').className = "list-group-item active"; 
  </script>
      ...
      <div class="card-body" style="background-color: #47484b">
        <div class="d-flex justify-content-between ">
          <div class="d-flex" style="align-items: center;justify-content: left;">
              <h2 class="card-title" style="color: #7d9801">DODAWANIE PRODUKTU</h2>
          </div>
        </div>

	  <form enctype="multipart/form-data" action="addingProduct.php" method="post">
  ...
  <div class="form-row">
    <div class="form-group col-md-2">
      <label for="CategoryID">Cena :</label>
      <input type="number" class="form-control" name="Price" placeholder="Cena">
    </div>
    <div class="form-group col-md-2">
      <label for="BrandID">Ilość :</label>
      <input type="number" class="form-control" name="Quantity" placeholder="Ilość">
    </div>
  </div>
